-- Repair audit log generation end-to-end. This is intentionally idempotent so it
-- can safely run on projects where earlier audit migrations partially applied.
